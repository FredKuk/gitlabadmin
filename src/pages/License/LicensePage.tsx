...
const mockData = {
  ...
  licenseButtons: ["View", "Download", "Upload"],
  certificateData: [
    { label: "ca", date: "2025.06.06~", content: "ca certificate content..." },
    { label: "ca-dev", date: "2025.06.06~", content: "ca-dev certificate content..." },
  ],
  serviceData: [
    { label: "gitlab rb", date: "2025.06.06~", content: "gitlab rb license content..." },
    { label: "nginx", date: "2025.06.06~", content: "nginx license content..." },
    ...
    <div className="license-page">
      ...
      >
        <div className="modal-content-area">
          ...
          <div className="modal-buttons">
            <button className="copy-button" onClick={() => navigator.clipboard.writeText(viewContent)}>
              Copy
            </button>
      ...
      >
        <div className="modal-upload-content">
          <input type="file" />
          <button className="upload-button" onClick={() => alert("Upload logic here")}>
            Upload
          </button>
        </div>
      </LicenseModal>
